...
def computational_intelligence(question):
    try:
        # Use the Groq client to get the answer
...
class Main(QMainWindow):
    ...
    def startTask(self):
        # Assuming the main window's size is known; if not, you can get it dynamically
        window_width = self.ui.centralwidget.width()  # Replace 'centralwidget' with your main widget name if needed
        window_height = self.ui.centralwidget.height()

        # Position label_3 in the center
        label_width = 1000
        label_height = 500
        x = (window_width - label_width) // 2
        y = (window_height - label_height) // 2

        self.ui.label_3.setGeometry(x, y, label_width, label_height)  # Set geometry for new.gif
        self.ui.movie = QtGui.QMovie("C:\\Users\\USER\\PycharmProjects\\test\\pyt\\dummy\\getu\\new.gif")
        self.ui.label_3.setMovie(self.ui.movie)
        self.ui.movie.start()

        # Continue with the rest of the labels and movies
        self.ui.label_2.setGeometry(720, 10, 200, 100)  # Position for logo.gif
        self.ui.movie = QtGui.QMovie("")
        self.ui.label_2.setMovie(self.ui.movie)
        self.ui.movie.start()

        self.ui.label_5.setGeometry(240,400, 500, 101)  # Position for path.gif
        self.ui.movie = QtGui.QMovie("C:\\Users\\USER\\PycharmProjects\\test\\pyt\\dummy\\getu\\path.gif")
